...
| `receptiveness_transform_judged.jsonl` | Fig 2 verdict-preservation judgments (`verdict_preservation`, n=1,892) |
...
| `hear/scores.jsonl` | HEAR rubric scores on Yeomans training texts |
